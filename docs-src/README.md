...
It is necessary to know assembly to be able to analyze the code produced by the Fortran compiler. I make some [assembly notes in a separate documentation](https://efurlanm.github.io/ldi/assembly/).
